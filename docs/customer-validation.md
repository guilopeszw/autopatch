...
[independent application check](adoption-check.md) records a blocked original baseline and a completed
prepared-starter migration; neither is customer evidence. The first participant should own a
